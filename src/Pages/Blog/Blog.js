    ...
    return (
        <div>
            ...
            <div className='w-3/5 mx-auto my-16'>
                ...
                <h1 className='text-yellow-600 lg:text-4xl md:text-3xl text-3xl font-bold my-10'>Some Helpful Answer For You</h1>


                <div className="collapse collapse-arrow my-5">
                    <input type="checkbox" />
                    <div className="collapse-title text-xl bg-yellow-500 rounded font-medium">
                ...
                <div className="flex-col lg:flex-row-reverse">
                    ...
                    <h1 className="text-3xl lg:text-4xl md:text-3xl text-center text-yellow-600 font-bold my-10">Wants To Ask Something!</h1>
                    ...
                    <form className=""action="https://formspree.io/f/mjvdgrqj" method="POST">
                        ...
                        <input type="email" name="email" className='text-black p-2 rounded text-sm'/>
                        </div>
                        ...
                        <textarea name="message" className='rounded p-8'></textarea>
